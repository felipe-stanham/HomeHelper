...
**ID:** I-0001
**Date:** 2026-04-26
**Status:** Promoted → P-0006
**For:** Latarnia (HomeHelper) spec assistant
**From:** Latarnik (the first Latarnia app to need runtime secrets)

> **Historical record.** This pitch predates the `pitch` skill and its `I-xxxx`
> convention, so it does not follow the current template (no Appetite or Cut List
> sections). It is kept verbatim as the origin of P-0006 — Secret Manager,
> which shipped `[DONE]` on 2026-04-29. Do not retrofit it to the template.
