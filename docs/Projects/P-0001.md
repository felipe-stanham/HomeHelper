...
## Shared Resources
- **Data Directory**: `/opt/latarnia/data/` - Each app has its own subdirectory
- **Logs Directory**: `/opt/latarnia/logs/` - Each app has its own subdirectory, no standard format
...
- [X] Project structure setup (`/opt/latarnia/` layout)
...
- [X] App discovery and manifest parsing (`latarnia.json`)
