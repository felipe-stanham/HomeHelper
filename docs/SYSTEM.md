...
| P-0003  | Dynamic MCP Port Allocation | [IN PROGRESS] | Runtime allocation of MCP ports from configured range. All 3 scopes landed; project stays open until the full integration test (Scope 3) is executed. |
